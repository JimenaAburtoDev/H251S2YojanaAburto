...
    // Obtener el elemento del navbar donde se muestra el nombre del usuario
    const usuarioElemento = document.getElementById('usuarioActual');
    
    // CAMBIO MÍNIMO: Verificación de existencia antes de asignar (Programación Defensiva)
    if (usuarioElemento) {
        usuarioElemento.textContent = usuarioLogeado;
    }
}
